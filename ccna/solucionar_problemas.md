...
Comando **debug** se introduce en modo privilegiado. Permite al administrador mostrar el proceso del SO, el protocolo, el mecanismo y los mensajes de eventos en tiempo real para su análisis. Para ver mas información **debug ?**

Para desactivar la depuración se puede usar los siguientes comandos. El último desactiva todos los debugs activos
